...
namespace BelKhidmah.Migrations
{
    ...
    [Migration("20260914080010_AddBiometricAuth")]
    partial class AddBiometricAuth
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BelKhidmah.Authentication.Biometric.BiometricChallenge", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("KeyId", "IsUsed", "ExpiresAt");

                    b.ToTable("BiometricChallenges", (string)null);
                });

            modelBuilder.Entity("BelKhidmah.Authentication.Biometric.UserBiometricKey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("UserBiometricKeys", (string)null);
                });
            ...
            modelBuilder.Entity("BelKhidmah.Otp.OtpCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("EmailOrPhone", "IsUsed");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("BelKhidmah.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("BelKhidmah.Authorization.Users.User", null)
                        .WithMany("Claims")
